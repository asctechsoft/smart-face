...
| [18-huong-dan-deploy-vps.md](./18-huong-dan-deploy-vps.md) | **Hướng dẫn deploy lên VPS**: Backend (API + worker) + Web Quản lý + AI Server bằng Docker Compose trên Ubuntu, sau Cloudflare. Nội dung đầy đủ 4 file cấu hình cần tạo, bảng biến môi trường kèm lý do, 6 chốt khiến container chết lúc khởi động, trình tự deploy/rollback, và bảng lỗi thường gặp | (từ mã nguồn) |
