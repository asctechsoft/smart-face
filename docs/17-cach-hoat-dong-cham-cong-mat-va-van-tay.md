# 17 — Chấm công bằng khuôn mặt và vân tay hoạt động thế nào
...
> Liên quan: [02 — Nghiệp vụ App Nhân viên](./02-nghiep-vu-app-nhan-vien.md) · [09 — Chống gian lận chấm công](./09-anti-fraud.md) · [15 — Hợp đồng API](./15-hop-dong-api.md)
>
> 👉 Muốn xem **đường đi thật của dữ liệu** qua từng chặng (payload cụ thể, thứ tự chốt kiểm, AI Server nhận và trả gì): [18 — Luồng chấm công chi tiết](./18-luong-cham-cong-chi-tiet.md)
...
> **Điểm quan trọng nhất:** AI Server chỉ trả về **con số**, Backend mới **so ngưỡng và quyết định**. Nhờ vậy khi muốn siết chặt hơn cho một công ty hay nghi ngờ có gian lận, chỉ cần đổi con số trong cấu hình — không phải deploy lại model AI. Đây là nguyên tắc `P3` trong [11 — Kiến trúc & Technology Stack](./11-kien-truc-va-technology-stack.md).
...
**Xem thêm:**
[02 — Nghiệp vụ App Nhân viên](./02-nghiep-vu-app-nhan-vien.md) (mục 2–5) ·
[09 — Chống gian lận chấm công](./09-anti-fraud.md) (`AF-05`, `AF-10`, `AF-12`) ·
[15 — Hợp đồng API](./15-hop-dong-api.md) (mục 3, 4, 8) ·
