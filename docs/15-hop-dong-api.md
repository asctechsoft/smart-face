...
**Lỗi** (theo `11-kien-truc-va-technology-stack.md` mục 9):
...
> Xem [13 mục 7](./19-luong-onboarding-va-dang-ky-khuon-mat.md#7-đăng-ký-lại--nơi-từng-có-lỗ-hổng).
...
Lỗi: toàn bộ nhóm `FACE_*` (xem `02-nghiep-vu-app-nhan-vien.md` mục 3.3), đặc biệt `FACE_DUPLICATE_IDENTITY` (409) khi trùng nhân viên khác (`BR-10`).
...
>
> Chi tiết: [13 mục 9](./19-luong-onboarding-va-dang-ky-khuon-mat.md#9-vân-tay--luồng-thay-thế).
...
// 200 — chấp nhận
{
  ...
  "data": {
    ...
    "insideGeofence": true,
    "photoUrl": "https://storage.googleapis.com/...?X-Goog-Signature=...",  // hết hạn 5 phút
    "flags": []
  }
}
...
**Tiếp theo:** [16 — Danh mục API Backend](./16-danh-muc-api-backend.md)
