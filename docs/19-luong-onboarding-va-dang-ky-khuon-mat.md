# 19 — Từ lúc được cấp tài khoản tới lúc chấm công được
...
> [18 — Luồng chấm công chi tiết](./18-luong-cham-cong-chi-tiet.md) ·
> [server-ai-smart/README.md](../server-ai-smart/README.md)

Tài liệu `18` mô tả luồng **chấm công hằng ngày** — luồng đó giả định nhân viên
...
> `currentPassword`; xem [08 mục 2](./15-hop-dong-api.md#2-api-xác-thực-auth).
>
...
`employeeCode` sinh từ họ tên theo `docs/01` mục 10: *"Nguyễn Văn Đức"* +
...
đầy đủ ở [09 — Chống gian lận chấm công](./09-anti-fraud.md).
...
> Công thức: [08 mục 1.2.1](./15-hop-dong-api.md#121-x-body-sha256--ràng-buộc-nội-dung-của-request-multipart).
...
> ⚠ **Phải là `!== true`, không phải `=== false`.** `action_verified` có ba
> trạng thái và `null` nghĩa là "không đo được", không phải "đạt". Xem chú thích
> cùng vấn đề ở [18 §8](./18-luong-cham-cong-chi-tiet.md).
...
công được — luồng đó ở [tài liệu 18](./18-luong-cham-cong-chi-tiet.md).
...
[docs/17](./17-cach-hoat-dong-cham-cong-mat-va-van-tay.md).
