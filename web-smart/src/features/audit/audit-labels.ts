...
export const ACTION_LABEL: Record<string, string> = {
  ...
  ATTENDANCE_REVIEW: 'Duyệt ngày công',
  ATTENDANCE_SHEET_CREATE: 'Tạo bảng công',
  ATTENDANCE_SHEET_CLOSE: 'Khoá bảng công',
  ATTENDANCE_SHEET_REOPEN: 'Mở lại bảng công',
  ATTENDANCE_SHEET_DELETE: 'Xoá bảng công',
  ATTENDANCE_SHEET_RECALCULATE: 'Tính lại bảng công',
  ATTENDANCE_SHEET_MEMBER_ADD: 'Thêm người vào bảng công',
  ATTENDANCE_SHEET_MEMBER_REMOVE: 'Bỏ người khỏi bảng công',
  PAYROLL_CLOSE: 'Chốt kỳ lương',
  PAYROLL_REOPEN: 'Mở lại kỳ lương',
  PAYROLL_RECALCULATE: 'Tính lại kỳ lương',
  PAYROLL_RECALCULATE_RANGE: 'Tính lại một khoảng ngày',
  PAYROLL_PERIOD_CREATE: 'Tạo kỳ lương',
  PAYROLL_SUBMIT_LOCK: 'Gửi duyệt chốt kỳ',
  PAYROLL_APPROVE_LOCK: 'Duyệt chốt kỳ',
  PAYROLL_REJECT_LOCK: 'Từ chối chốt kỳ',
  PAYROLL_REOPEN_REQUESTED: 'Đề nghị mở lại kỳ',
  PAYROLL_APPROVE_REOPEN: 'Duyệt mở lại kỳ',
  WORK_STATUS_REMIND: 'Nhắc chấm công',
