    ...
    >
      <div style={{ maxWidth: 'var(--sf-content-max-width)', marginInline: 'auto' }}>
        ...
        <Section
          id="nut"
          title="11.1 · Nút"
          note="Nút amber SÁNG LÊN khi rê chuột, không tối đi (mục 0.1). Nhấn giữ nguyên màu, dùng bóng lõm + dịch 1px."
        >
        ...
        <Section
          id="o-nhap"
          title="11.5 · Ô nhập"
          note="Nhãn hiển thị thường trực — placeholder không thay thế được nhãn (mục 14.2 điều 5)."
        >
          <div
            style={{
              display: 'grid',
          ...
          >
            ...
            <Field label="Trạng thái lỗi" required error="Họ và tên không được để trống.">
        ...
        <Section
          id="chip"
          title="11.6 · Chip lọc"
          note='Dùng <button role="switch" aria-checked>, không dùng <div>.'
        >
          ...
          <Row label="Thử">
            ...
            <Button
              ...
              onClick={() =>
                toast.warning(
                  'Còn 3 đơn chờ duyệt',
                  'Chốt kỳ khi còn tồn đọng dễ gây khiếu nại lương.',
                )
              }
            >
              Toast cảnh báo
            ...
            <Button
              ...
              onClick={() =>
                toast.error(
                  'Không lưu được hiệu chỉnh',
                  'Kỳ lương chứa ngày này đã chốt. Mở lại kỳ rồi thử lại.',
                )
              }
            >
              Toast lỗi
        ...
        <Section
          id="bulk"
          title="11.17 · Thanh hành động hàng loạt"
          note='Có aria-live="polite" thông báo số dòng đã chọn.'
        >
        ...
        <Section
          id="rong-loi"
          title="11.18 · Trạng thái rỗng và lỗi"
          note="Mô tả là bắt buộc — phải nói được làm gì tiếp theo, không chỉ 'Không có dữ liệu'."
        >
          <div
            style={{
              display: 'grid',
