 ...
 * lưới người × ngày.
 *
 * Đây là tab "Lịch phân ca" của màn **Ca làm & Phân ca** (`ShiftsPage`), không
 * phải một trang đứng riêng: tiêu đề trang và nút "Lập bảng phân ca" đều thuộc
 * về trang chủ quản, theo đúng thiết kế đặt nút ngang hàng với thanh tab. Nút
 * đó đặt `?new=1` trên thanh địa chỉ và biểu mẫu ở đây mở theo — cùng cơ chế
 * với tab danh mục ca, và đổi lại được một đường dẫn mở thẳng biểu mẫu.
 */
  ...
  return (
    <>
      ...
      <DataTable<ShiftSchedule>
        ...
        emptyAction={
          canAssign ? (
            <Button type="primary" onClick={() => patchQuery({ new: '1' })}>
              Lập bảng phân ca
            </Button>
          ) : undefined
        }
      ...
      <ShiftScheduleFormModal open={formOpen} onClose={() => patchQuery({ new: undefined })} />
